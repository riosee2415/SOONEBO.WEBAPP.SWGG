...
router.post(
  ...
  isAdminCheck,
  async (req, res, next) => {
    const { id, title, subTitle, link, content, imagePath, mobileImagePath } =
      req.body;

    try {
      const updateResult = await MainBanner.update(
        { title, subTitle, link, content, imagePath, mobileImagePath },
        {
...
router.post(
  ...
  isAdminCheck,
  async (req, res, next) => {
    const { title, subTitle, link, content, imagePath, mobileImagePath } =
      req.body;
