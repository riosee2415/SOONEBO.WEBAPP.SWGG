...
const opinionRouter = require("./routers/opinionRouter");
const faqRouter = require("./routers/faqRouter");
const productRouter = require("./routers/productRouter");
const wishRouter = require("./routers/wishRouter");
const reviewRouter = require("./routers/reviewRouter");
const userPointRouter = require("./routers/userPointRouter");
...
const cancelRouter = require("./routers/cancelRouter");
...
if (process.env.NODE_ENV === "production") {
  ...
  app.use(
    cors({
      origin: ["https://sunaebo-swgg.com", "https://www.sunaebo-swgg.com", "*"],
      credentials: true,
    })
  );
} else {
...
app.use("/api/point", userPointRouter);
