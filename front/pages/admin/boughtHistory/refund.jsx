...
import { Table, Button, Modal, Image, Popconfirm } from "antd";
...
const Cancel = ({}) => {
  ...
  return (
    <AdminLayout>
      <PageHeader
        breadcrumbs={["주문 관리", "반품 관리"]}
        title={`반품 관리`}
        subTitle={`회원이 반품한 내역을 관리할 수 있습니다.`}
      />
      ...
      <AdminContent>
        ...
        >
          <GuideDiv isImpo={true}>
            회원이 반품한 상품을 확인 할 수 있습니다.
          </GuideDiv>
          <GuideDiv isImpo={true}>
            회원이 반품한건에 대해서 승인 후 수정이 불가합니다.
          </GuideDiv>
          <GuideDiv isImpo={true}>
              ...
              >
                ...
                <Wrapper width={width < 900 ? `100%` : `60%`}>
                  ...
                  >
                    ...
                    <Wrapper width={`60%`}>{data.productTitle}</Wrapper>
                  </Wrapper>
