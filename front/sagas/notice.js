...
function noticeDeleteAPI(data) {
  return axios.patch(`/api/notice/delete`, data);
}
...
// SAGA AREA ********************************************************************************************************
// ******************************************************************************************************************
function noticeUploadAPI(data) {
  return axios.post(`/api/notice/file`, data);
}

function* noticeUpload(action) {
  try {
    const result = yield call(noticeUploadAPI, action.data);
...
function* watchNoticeUpload() {
  yield takeLatest(NOTICE_UPLOAD_REQUEST, noticeUpload);
}
