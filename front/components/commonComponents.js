...
export const RsWrapper2 = styled.article`
  width: 1600px;
  height: ${(props) => props.height || `100%`};
  ${(props) => props.minHeight}
  color: ${(props) => props.color};
...
export const CommonButton = styled(Button)`
  ...
  ${(props) =>
    props.kindOf === `white` && `color : ${props.theme.lightGrey_C};`}
  ${(props) =>
    props.kindOf === `white` &&
  ...
  ${(props) =>
    props.kindOf === `basicTheme` &&
    `background : ${props.theme.basicTheme_C};`}
  ${(props) =>
    props.kindOf === `basicTheme` && `color : ${props.theme.white_C};`}
  ${(props) =>
    props.kindOf === `basicTheme` &&
  ...
  ${(props) =>
    props.kindOf === `kakao` && `color : ${props.theme.kakaoBlack_C};`}
  ${(props) =>
 ...
 ${(props) =>
    props.kindOf === `outline` && `background : ${props.theme.white_C};`}
  ${(props) => props.kindOf === `outline` && `color : ${props.theme.grey2_C};`}
  ${(props) =>
    props.kindOf === `outline` && `border : 1px solid ${props.theme.grey5_C};`}
  ...
  &:hover {
    ...
    ${(props) =>
      props.kindOf === `basicTheme` && `color ${props.theme.basicTheme_C};`}
    ${(props) => props.kindOf === `basicTheme` && `background: transparent;`}
    ${(props) =>
      props.kindOf === `basicTheme` &&
      `border: 1px solid ${props.theme.basicTheme_C};`}
    ...
    ${(props) => props.kindOf === `kakao` && `background : transparent;`}
    ${(props) =>
      props.kindOf === `kakao` && `color : ${props.theme.kakaoBlack_C};`}
    ${(props) =>
      props.kindOf === `kakao` && `border : 1px solid ${props.theme.kakao_C};`}
    ...
    ${(props) =>
      props.kindOf === `outline` && `background : ${props.theme.grey5_C};`}
    ${(props) =>
      props.kindOf === `outline` && `color : ${props.theme.white_C};`}
    ${(props) =>
      props.kindOf === `outline` &&
      `border : 1px solid ${props.theme.grey5_C};`}
  }
...
export const StyleBtn = styled(Wrapper)`
  width: ${(props) => props.width};
  text-align: center;
  position: relative;
  height: ${(props) => props.height};
...
export const TextInput = styled.input`
  ...
  &:focus {
    outline: none;
    border-bottom: 1px solid ${(props) => props.theme.subTheme_C};
  }
...
export const TextArea = styled.textarea`
  ...
  padding: ${(props) => props.padding || `10px`};
  border: ${(props) => props.border || `1px solid ${props.theme.lightGrey4_C}`};
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 2px rgba(255, 72, 150, 0.2);
  }
